...
$mail = trim($_POST["entry_1389752944"]);
$phone = trim($_POST["entry_957670452"]);
$name = trim($_POST["entry_397525899"]);
...
$city_event = 'Киев'; #City of current event
...
$price_lead = '11 750'; #Current year for lead name
if (empty($name)) {
