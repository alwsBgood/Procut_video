...
$recepient2 = "best_editor@ukr.net";
$sitename = "PROCUT VIDEOMAKING";

$mail = trim($_GET["entry_1389752944"]);
$phone = trim($_GET["entry_957670452"]);
$country = trim($_GET["country"]);
$data_form= trim($_GET["data_form"]);
$name = trim($_GET["entry_397525899"]);
$city = trim($_GET["city"]);
$additional_field = trim($_GET["entry_2488681"]);
...
mail($recepient2, $pagetitle, $message, $headers);
